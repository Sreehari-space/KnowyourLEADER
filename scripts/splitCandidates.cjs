...
const DETAIL_FIELDS = [
  ...
  'pendingCasesDetails',
  'caseSummary',
  // 'discrepancies' is deliberately not carried through. The field held
  // accusations generated by a pipeline that mixed metals in the gold checks
  // and billed candidates for our own parse failures; see the header of
  // scripts/buildDeclarationFlags.cjs. Flags now come from that script instead,
  // into public/data/declaration_flags.json, keyed by candidate id.
