...
export default function Home({ candidates, lang, fontSize }: HomeProps) {
  ...
  const heroFigures = [
    ...
    // Filename is versioned deliberately: files in public/ are served unhashed,
    // so replacing artwork in place leaves browsers on the cached copy. Bump the
    // suffix whenever this image changes.
    { key: 'Udhayanithi', src: '/udhayanithi-dmk.png', alt: 'Udhayanithi', party: 'DMK', zBase: 20, offset: 'right-0 sm:right-[15px] md:right-[20px]', opacityBase: 0.7 },
